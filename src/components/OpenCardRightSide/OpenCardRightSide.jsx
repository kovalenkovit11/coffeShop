...
const OpenCardRightSide = () => {
  return (
    <div className='right-side'>
        ...
        <ButtonAddToCart colorText='#111111' backgroundColor='#ededed' svgColor='#111' width='403px'/>
...
<path d="M19 9L12.0368 15.9632L5.07366 9" stroke="#828282" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
    </div>
    <div className="description">
        <p>Характеристики</p>
